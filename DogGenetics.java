...
public class DogGenetics {
	...
	public static void main(String[] args) {
		...
		// Subtract from this each time
		int remainingPercent = 100;
		int random;

		// Do first 4 dog breeds
		for (int i = 0; i < 4; i++) {
			// Calculate it such that minimum is 1%
	...
	/**
	 * A list of breeds I found online hardcoded in a List.
	 * The program shuffles this list to draw breeds randomly.
	 */
